...
IF OBJECT_ID(N'dbo.Custsomer', N'U') IS NOT NULL 
BEGIN
...
( 
     CustomerId INT IDENTITY(0001,1) NOT NULL,
...
INSERT INTO dbo.Customer(FirstName, LastName, AddressLineOne, AddressLineTwo, City, Postcode, Email,
                            Username, Password)
VALUES('WalkInCustomer', 'HasNotSignedUp', 'LocalWalkIn', NULL, 'Plymouth', 'PL1 1LP', 'drinks&snacks.walkin@gmail.com', 'Generic', 'Customer');


IF OBJECT_ID(N'dbo.Admin', N'U') IS NOT NULL 
BEGIN
...
( 
     AdminId INT IDENTITY(0001,1) NOT NULL,
     FirstName NVARCHAR(40) NOT NULL,
     LastName NVARCHAR(40) NOT NULL,
     Email NVARCHAR(80) NOT NULL,
     Username NVARCHAR(20) NOT NULL,
...
INSERT INTO dbo.Admin(FirstName, LastName, Email, Username, Password)
