...
$CONFIG = [
	...
	"RANDOM_KEY" => 'lbJqcyZ4wcQWbD7x', // Random key for encryption
	...
	"PROJECT_ID" => "{B0D90454-D781-4E44-832A-8439DCD087B1}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "proj-mysql.uopnet.plymouth.ac.uk", "port" => 3306, "user" => "ISAD251_SDaniel", "pass" => "ISAD251_22201615", "db" => "isad251_sdaniel"]
	],
	...
	"USER_TABLE_NAME" => "admin",
	"LOGIN_USERNAME_FIELD_NAME" => "admin_username",
	"LOGIN_PASSWORD_FIELD_NAME" => "admin_password",
	...
	"USER_TABLE_DBID" => "DB",
	"USER_TABLE" => "`admin`",
	"USER_NAME_FILTER" => "(`admin_username` = '%u')",
	"USER_ID_FILTER" => "",
	"USER_EMAIL_FILTER" => "",
