...
class products extends DbTable
{
	...
	public function __construct()
	{
		...
		// product_id
		$this->product_id = new DbField('products', 'products', 'x_product_id', 'product_id', '`product_id`', '`product_id`', 3, 11, -1, FALSE, '`product_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// product_name
		$this->product_name = new DbField('products', 'products', 'x_product_name', 'product_name', '`product_name`', '`product_name`', 200, 255, -1, FALSE, '`product_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// product_image
		$this->product_image = new DbField('products', 'products', 'x_product_image', 'product_image', '`product_image`', '`product_image`', 200, 255, -1, FALSE, '`product_image`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->product_image->Sortable = TRUE; // Allow sort
		$this->fields['product_image'] = &$this->product_image;

		// product_description
		$this->product_description = new DbField('products', 'products', 'x_product_description', 'product_description', '`product_description`', '`product_description`', 201, 65535, -1, FALSE, '`product_description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->product_description->Sortable = TRUE; // Allow sort
		$this->fields['product_description'] = &$this->product_description;

		// product_price
		$this->product_price = new DbField('products', 'products', 'x_product_price', 'product_price', '`product_price`', '`product_price`', 131, 12, -1, FALSE, '`product_price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function renderEditRow()
	{
		...
		$this->product_description->PlaceHolder = RemoveHtml($this->product_description->caption());
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->product_description);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->product_description);
