...
class customers_add extends customers
{
	...
	protected function loadDefaultValues()
	{
		...
		$this->customer_firstname->CurrentValue = NULL;
		$this->customer_firstname->OldValue = $this->customer_firstname->CurrentValue;
		$this->customer_lastname->CurrentValue = NULL;
		$this->customer_lastname->OldValue = $this->customer_lastname->CurrentValue;
		$this->customer_addresslineone->CurrentValue = NULL;
		$this->customer_addresslineone->OldValue = $this->customer_addresslineone->CurrentValue;
		$this->customer_addresslinetwo->CurrentValue = NULL;
		$this->customer_addresslinetwo->OldValue = $this->customer_addresslinetwo->CurrentValue;
		$this->customer_city->CurrentValue = NULL;
		$this->customer_city->OldValue = $this->customer_city->CurrentValue;
		$this->customer_postcode->CurrentValue = NULL;
		$this->customer_postcode->OldValue = $this->customer_postcode->CurrentValue;
		$this->customer_email->CurrentValue = NULL;
		$this->customer_email->OldValue = $this->customer_email->CurrentValue;
		$this->customer_username->CurrentValue = NULL;
		$this->customer_username->OldValue = $this->customer_username->CurrentValue;
		$this->customer_password->CurrentValue = NULL;
		$this->customer_password->OldValue = $this->customer_password->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['customer_firstname'] = $this->customer_firstname->CurrentValue;
		$row['customer_lastname'] = $this->customer_lastname->CurrentValue;
		$row['customer_addresslineone'] = $this->customer_addresslineone->CurrentValue;
		$row['customer_addresslinetwo'] = $this->customer_addresslinetwo->CurrentValue;
		$row['customer_city'] = $this->customer_city->CurrentValue;
		$row['customer_postcode'] = $this->customer_postcode->CurrentValue;
		$row['customer_email'] = $this->customer_email->CurrentValue;
		$row['customer_username'] = $this->customer_username->CurrentValue;
		$row['customer_password'] = $this->customer_password->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// customer_firstname
		$this->customer_firstname->setDbValueDef($rsnew, $this->customer_firstname->CurrentValue, "", FALSE);

		// customer_lastname
		$this->customer_lastname->setDbValueDef($rsnew, $this->customer_lastname->CurrentValue, "", FALSE);

		// customer_addresslineone
		$this->customer_addresslineone->setDbValueDef($rsnew, $this->customer_addresslineone->CurrentValue, "", FALSE);

		// customer_addresslinetwo
		$this->customer_addresslinetwo->setDbValueDef($rsnew, $this->customer_addresslinetwo->CurrentValue, NULL, FALSE);

		// customer_city
		$this->customer_city->setDbValueDef($rsnew, $this->customer_city->CurrentValue, "", FALSE);

		// customer_postcode
		$this->customer_postcode->setDbValueDef($rsnew, $this->customer_postcode->CurrentValue, "", FALSE);

		// customer_email
		$this->customer_email->setDbValueDef($rsnew, $this->customer_email->CurrentValue, "", FALSE);

		// customer_username
		$this->customer_username->setDbValueDef($rsnew, $this->customer_username->CurrentValue, "", FALSE);

		// customer_password
		$this->customer_password->setDbValueDef($rsnew, $this->customer_password->CurrentValue, "", FALSE);
