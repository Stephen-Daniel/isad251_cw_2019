...
class products_edit extends products
{
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// product_image
			$this->product_image->setDbValueDef($rsnew, $this->product_image->CurrentValue, NULL, $this->product_image->ReadOnly);

			// product_description
			$this->product_description->setDbValueDef($rsnew, $this->product_description->CurrentValue, NULL, $this->product_description->ReadOnly);
