...
class products_list extends products
{
	...
	public function run()
	{
		...
		$this->product_description->Visible = FALSE;
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->product_image->AdvancedSearch->toJson(), ","); // Field product_image
		$filterList = Concat($filterList, $this->product_description->AdvancedSearch->toJson(), ","); // Field product_description
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->product_image, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->product_description, $arKeywords, $type);
		return $where;
	}
