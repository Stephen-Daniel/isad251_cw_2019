 ...
 * Page class
 */
class orders_items_edit extends orders_items
{
	...
	// Page object name
	public $PageObjName = "orders_items_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_order_id")) {
				$this->order_id->setFormValue($CurrentForm->getValue("x_order_id"));
			}
